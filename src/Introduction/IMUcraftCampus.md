...
<!-- 服务器状态横幅自适应样式（全局生效，仅在当前文档） -->
<style>
.mc-server-banner {
  width: 100%;          /* 宽度占满父容器 */
  max-width: 800px;     /* 大屏最大宽度，避免拉伸模糊 */
  height: auto;         /* 自动按比例缩放，防止变形 */
...
<img 
  ...
  alt="IMUcraft 服务器实时状态"
  title="IMUcraft 服务器在线人数/状态"
>
